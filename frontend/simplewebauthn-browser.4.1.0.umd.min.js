...
!function(e, t) {
    ...
    e.startAuthentication = async function(e, c=!1) {
        ...
        if (c) {
            ...
            f.mediation = "conditional",
            h.allowCredentials = []
        }
        let p;
        f.publicKey = h,
        f.signal = s.createNewAbortSignal();
        try {
        ...
        let A;
        return E.userHandle && (A = t(E.userHandle)),
        {
            id: R,
            rawId: t(w),
            response: {
    ...
    e.startRegistration = async function(e) {
            ...
            throw function({error: e, options: t}) {
                ...
                if ("AbortError" === e.name) {
                    ...
                    if ("NotSupportedError" === e.name)
                        return 0 === r.pubKeyCredParams.filter((e=>"public-key" === e.type)).length ? new a({
        ...
        let w, E, g, A;
        if ("function" == typeof p.getTransports && (w = p.getTransports()),
